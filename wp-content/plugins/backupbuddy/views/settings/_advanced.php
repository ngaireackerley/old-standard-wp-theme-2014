...
$settings_form->add_setting( array(
	...
	'css'		=>		'',
	'after'		=>		' <span style="white-space: nowrap;"><span class="description">' . __( 'Located in backup', 'it-l10n-backupbuddy' ) . ':</span>&nbsp; <span class="code" style="white-space: normal; background: #EAEAEA;"">/wp-content/uploads/backupbuddy_temp/xxxxxxxxxx/importbuddy.php</span>',
	'rules'		=>		'required',
) );
