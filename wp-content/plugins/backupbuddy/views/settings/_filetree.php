...
<script type="text/javascript">
	jQuery(document).ready(function() {
		...
		jQuery('#exlude_dirs').fileTree(
			...
			function(directory) {
				if ( ( directory == '/wp-content/' ) || ( directory == '/wp-content/uploads/' ) || ( directory == '<?php echo backupbuddy_core::getBackupDirectory(); ?>' ) || ( directory == '/wp-content/uploads/backupbuddy_temp/' ) ) {
